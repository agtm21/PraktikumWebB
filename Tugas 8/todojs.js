function cb(){
    var check = document.createElement("input");//variabel
    var text = document.createElement("p");//variabel
    var del = document.createElement('button');//variabel
    var t = document.createTextNode('Hapus');//variabe;
